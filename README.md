...
ในไฟล์ `assets.thaifixes.config.classmap.properties` จะเป็นโฟลเดอร์ที่ตั้งค่าชื่อของฟิลด์, คลาสและเมธอดต่างๆ แต่ในละเวอร์ชันจะแตกต่างกันออกไป ให้ทำการแก้ไขให้ตรงกับเวอร์ชันที่ต้องการ
