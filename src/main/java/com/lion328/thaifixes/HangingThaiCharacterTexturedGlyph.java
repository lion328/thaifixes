...
public class HangingThaiCharacterTexturedGlyph extends TexturedGlyph
{
    ...
    private HangingThaiCharacterTexturedGlyph()
    {
    ...
    public static HangingThaiCharacterTexturedGlyph fromParent(TexturedGlyph glyph)
    {
        if (parentFields == null) {
            return null;
        }

        HangingThaiCharacterTexturedGlyph ret = new HangingThaiCharacterTexturedGlyph();
